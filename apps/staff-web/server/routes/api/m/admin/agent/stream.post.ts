...
//
// The action's requireAdmin() throws a Response 401/403 BEFORE the stream
// opens for non-admins; the catch branch forwards those as clean HTTP statuses.
import { defineEventHandler, sendWebResponse } from "h3";
import { action } from "../../../../../../app/routes/api.m.admin.agent.stream.js";
