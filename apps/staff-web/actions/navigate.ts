...
export default defineAction({
  description:
    "Navigate the staff UI to a specific gymos route (home, inbox, schedule, members, analytics, campaigns, forms, brain, content, video, settings). Writes a navigate command to application state which the UI reads and auto-deletes.",
  schema: z.object({
    view: z
      .string()
      .optional()
      .describe(
        "Gymos route to navigate to: home, inbox, schedule, members, analytics, campaigns, forms, brain, content, video, settings",
      ),
