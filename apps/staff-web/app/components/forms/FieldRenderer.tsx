// Forked from templates/forms/app/components/builder/FieldRenderer.tsx
// Changes from upstream:
//   - Replaced `@shared/types` import with the forked features/forms/types.ts
//     (staff-web's @shared/ maps to shared/ which has Mail types, not form types)
//   - All @/ and @shared/ imports remain compatible with apps/staff-web tsconfig
//   - No ~/  aliases (not available in staff-web)
