// Forked from templates/forms/app/components/builder/FieldPropertiesPanel.tsx
// Changes from upstream:
//   - Replaced `@shared/types` with the forked features/forms/types.ts
//   - No ~/  aliases; no @agent-native/core/client imports
//   - All UI components come from @/components/ui/*
...
import type { FormField, FormFieldType } from "../../../features/forms/types";
