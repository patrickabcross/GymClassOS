...
const INTEGRATIONS: IntegrationDef[] = [
    ...
    logo: (
      ...
      >
        <path
          ...
          fill="#F8FF2C" // guard:allow-color — third-party integration brand colors (MYÜTIK/HubSpot/etc)
        />
        <path
  ...
  },
  {
    ...
    logo: (
      ...
      >
        <path
          fill="#FF7A59" // guard:allow-color — third-party integration brand colors (MYÜTIK/HubSpot/etc)
          fillRule="nonzero"
    ...
    logo: (
      ...
      >
        <path
          ...
          fill="#7121DB" // guard:allow-color — third-party integration brand colors (MYÜTIK/HubSpot/etc)
        />
      </svg>
    ),
  },
    ...
    logo: (
      ...
      >
        <path
          ...
          fill="#5B0EFF" // guard:allow-color — third-party integration brand colors (MYÜTIK/HubSpot/etc)
        />
      </svg>
    ),
  },
