...
Plans:
- [ ] P3-ai-noticeboard-01-dashboard-storage-PLAN.md (wave 1) — additive migration 0005 (dashboard_notes/tasks/proposals) applied to gymos-demo Neon + Drizzle schema exports [SC-3, SC-4, SC-5]
